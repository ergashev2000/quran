<template>
  <div :class="`bg-[#1f2125] w-full fixed bottom-0 z-50 transition-all duration-500 ${props.audio?.src ? 'translate-y-0' : 'translate-y-full'
    } `">
    ...
    <div class="flex gap-2 items-center justify-center">
      ...
      <audio ref="audioElement" :src="props?.audio?.src" autoplay @timeupdate="updateProgress">
      ...
      <div class="mt-2 flex gap-2 items-center">
        <div>
          <button @click="skipBackward">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#fff"
              stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-skip-back">
        ...
        <div v-if="!isPlaying">
          <button @click="togglePlayPause">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#fff"
              stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-play-circle">
        ...
        <div>
          <button @click="skipForward">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#fff"
              stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-skip-forward">
...
const togglePlayPause = () => {
  if (audioElement.value.paused) {
    ...
    playerToggle.togglePlayPauseSurahs(false)
